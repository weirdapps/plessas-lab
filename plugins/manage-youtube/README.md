...
This plugin provides the `manage-youtube` skill which Claude will use automatically based on context.

## Documentation

See `skills/manage-youtube/SKILL.md` for complete documentation.
